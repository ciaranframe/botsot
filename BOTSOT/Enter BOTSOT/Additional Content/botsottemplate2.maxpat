...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 68.0, 50.0, 101.0, 19.0 ],
					"style" : "",
					"text" : "None"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-4",
					"items" : [ "None", ",", "Jacaranda", "mimosifolia", ",", "Wollemia", "nobilis", ",", "Ficus", "obliqua", ",", "Acer", "palmatum", ",", "Salvia", "microphylla", ",", "Banksia", "integrifolia", ",", "Trachelospermum", "jasminoides", ",", "Eucalyptus", "saligna", ",", "Corymbia", "ficifolia", ",", "Anigozanthos", "flavidus" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
