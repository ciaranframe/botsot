...
, 			{
				"box" : 				{
					"id" : "obj-4",
					"items" : [ "None", ",", "Jacaranda", ",", "Sydney", "Blue", "Gum", ",", "West", "Aust.", "Red", "Flowering", "Gum", ",", "Scribbly", "Gum", ",", "Flooded", "Gum" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "unknown.png",
				"bootpath" : "/Volumes/CIARAN2/BOTSOT/Additional Content/Images",
...
, 			{
				"name" : "Plant_info4",
				"bootpath" : "/Volumes/CIARAN2/BOTSOT/Additional Content/Data and colls",
